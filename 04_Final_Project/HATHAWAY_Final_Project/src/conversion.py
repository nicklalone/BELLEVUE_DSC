...
def transform_record(rdict):
    ...
    """
    rdict["respondentid"] = to_int(rdict["respondentid"])
    rdict["do_you_typically_check_a_daily_weather_report"] = to_bool(rdict["do_you_typically_check_a_daily_weather_report"])
