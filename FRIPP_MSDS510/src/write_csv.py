...
def main(input_csv, output_csv):
    with open(input_csv) as a:
        csv_reader = csv.DictReader(a)
        records = [record for record in csv_reader]
        fieldnames = csv_reader.fieldnames

    # Create list of names from the 'friendly names' clean
    ...
    with open(output_csv, 'w') as a:
        csv_writer = csv.DictWriter(a, fieldnames = python_friendly_names)
